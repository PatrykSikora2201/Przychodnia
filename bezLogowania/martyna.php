            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="submenu">
                        ...
                        <a class="dropdown-item active" href="martyna.php"> Martyna Szalony </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 bg-white text-body wpis">
                    ...
                    <blockquote class="blockquote">
                        ...
                        <p class="mb-1">Psycholog. Zajmuje się stanami depresyjnymi i zaburzeniami osobowości.

                        <p><b>Wykonywane zabiegi:</b></p>
                        <p>Terapia autopoznawcza</p>
                        <p><b>Wykształcenie:</b></p>
                        <p>Ukończyła II Liceum Ogólnokrztałcące w Rzeszowie</p>
