      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="submenu">
            ...
            <a class="dropdown-item active" href="marta.php"> Marta Sondej </a>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 bg-white text-body wpis">
          ...
          <blockquote class="blockquote">
            ...
            <p class="mb-1">Lekarz specjalista ortopeda. Zajmuje się diagnostyką i leczeniem chorób kręgosłupa i kości.

            <p><b>Wykonywane zabiegi:</b></p>
            <p>łamanie kości</p>
            <p><b>Wykształcenie:</b></p>
            <p>Ukończył Wydział Lekarski Uniwersytetu Medycznego w Warszawie</p>
            <p><b>Doświadczenie:</b></p>
            <p>Staż podyplomowy w Uniwersyteckim Szpitalu Klinicznym w Rzeszowie</p>
