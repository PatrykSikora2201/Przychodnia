			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="submenu">
						...
						<a class="dropdown-item active" href="mariusz.php"> Mariusz Miras </a>
				...
				<div class="row">
					...
					<div class="col-lg-8 bg-white text-body wpis">
						...
						<header>
							...
							<h1 class="h2 font-weight-bold text-uppercase ml-0 mb-4 text-center text-md-left">Mariusz Miras</h1>
						...
						<blockquote class="blockquote">
							...
							<p class="mb-1">Lekarz specjalista kardiolog. Zajmuje się diagnostyką i leczeniem chorób układu krążenia.

                            <p><b>Wykonywane zabiegi:</b></p>
                            <p>Echo serca</p>
                            <p><b>Wykształcenie:</b></p>
                            <p>Ukończył Wydział Lekarski Uniwersytetu Medycznego w Białymstoku</p>
                            <p>Uzyskał stopień naukowy doktora nauk medycznych nadany uchwałą Rady Naukowej Instytutu Kardiologii</p>
                            <p><b>Doświadczenie:</b></p>
                            <p>Staż podyplomowy w Uniwersyteckim Szpitalu Klinicznym w Białymstoku</p>
                            <p>Kardiolog w Klinice Wad Nabytych Serca Instytutu Kardiologii w Aninie</p>
                            <footer class="blockquote-footer">Marta Sondej</footer>
					...
					<aside class="col-lg-4">
						...
						<img class="img-thumbnail" src="../img/doc2.jpg" alt="Kamil Stoch">
						
						<h3 class="h4 my-4">Lekarze</h3>
						<ul class="list-group">
							<a href="mariusz.php" class="list-group-item list-group-item-dark list-group-item-action active">Mariusz Miras</a>
							<a href="marta.php" class="list-group-item list-group-item-dark list-group-item-action">Marta Sondej</a>
							<a href="martyna.php" class="list-group-item list-group-item-dark list-group-item-action">Martyna Szalony</a>
						</ul>
