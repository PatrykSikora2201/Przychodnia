			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="submenu">
						...
						<a class="dropdown-item" href="mariusz2.php"> Mariusz Miras </a>
				...
				<div class="row">
					...
					<div class="col-lg-8 bg-white text-body wpis">
						...
						<blockquote class="blockquote">
							...
							<p class="mb-1">Miałem niezbyt udany początek. Pewnie wynikało to z tego, że nastąpiła zmiana przepisów odnośnie kombinezonów. Muszę przyznać, że ze zmienionymi strojami nie czułem się najlepiej. (...) Zbyt mocno to wszystko wziąłem do siebie.</p>
							
							<footer class="blockquote-footer">Mariusz Miras</footer>
					...
					<aside class="col-lg-4">
						...
						<ul class="list-group">
							<a href="mariusz2.php" class="list-group-item list-group-item-dark list-group-item-action active">Mariusz Miras</a>
