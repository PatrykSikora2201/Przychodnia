      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="submenu">
            ...
            <a class="dropdown-item" href="marta2.php"> Marta Sondej </a>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 bg-white text-body wpis">
          ...
          <header>
            ...
            <h1 class="h2 font-weight-bold text-uppercase ml-0 mb-4 text-center text-md-left">Marta Sondej</h1>
        ...
        <aside class="col-lg-4">
          ...
          <img class="img-thumbnail" src="../img/doc1.jpg" alt="Marta Sondej">
          ...
          <ul class="list-group">
            ...
            <a href="marta2.php" class="list-group-item list-group-item-dark list-group-item-action active">Marta Sondej</a>
