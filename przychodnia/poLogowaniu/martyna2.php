            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="submenu">
                        ...
                        <a class="dropdown-item" href="martyna2.php"> Martyna Szalony </a>
            ...
            <div class="row">
                ...
                <aside class="col-lg-4">
                    ...
                    <ul class="list-group">
                        ...
                        <a href="martyna2.php" class="list-group-item list-group-item-dark list-group-item-action active">Martyna Szalony</a>
                    </ul>
